<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Category4.aspx.cs" Inherits="ColumnTable3" %>
                    ...
                    <div class="box-body">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Select <asp:Label ID="lblCate3Name1" runat="server" Text=""></asp:Label></label>
                                    ...
                                    <table id="example111" class="table table-bordered table-striped dtSearch">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>ID</th>
                                                 <th><asp:Label ID="lblCat3Name" runat="server" Text=""></asp:Label></th>
                                                ...
                                                <ItemTemplate>
                                                    <tr>
                                                        <td><%# Eval("Cat4ID")%> </td>
                                                         <td><%# Eval("C3Name")%> </td>
                                                        <td><%# Eval("C4Name")%> </td>
                                                        <td><%# Eval("C4Abbriviation")%> </td>
                                                        <td>
                                                            <asp:ImageButton ID="ImageButton1" runat="server" CommandName="edit"
                                                                ImageUrl="images/edit.png" CommandArgument='<%# Eval("Cat4ID") %>' />
