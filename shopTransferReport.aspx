<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="shopTransferReport.aspx.cs" Inherits="shopTransferReport" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <div class="content-wrapper"> <section class="content-header">
        <h1>Shop Transfer Report 
            ...
            <div class="box-body">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Shop Transfer Report</h3>
                         ...
                         <div class="row">
                           ...
                           <table class="table table-bordered">
                             ...
                             <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator1"
                                   ...
                                   <td>
                                       <asp:LinkButton ID="GetRpt" runat="server" CssClass="btn btn-sm btn-success pull-right" OnClick="btnGetRpt_Click" ValidationGroup="go"><i class="fa fa-list"></i> Get Report</asp:LinkButton>
                                   </td>
