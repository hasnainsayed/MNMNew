...
public partial class Column10 : System.Web.UI.Page
{
    ...
    protected void rptr_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        if (e.CommandName.ToLower().Equals("edit"))
        {
            ...
            DataSet ds = objEdit.GetCol10ByID(ID);

            txtName.Text = ds.Tables[0].Rows[0]["C10Name"].ToString();
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        int ID = objAdd.AddCol10(txtName.Text.Trim());
        if (ID > 0)
        {
            BindColumn10();
            Clear();
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        int Success = objUpdate.UpdateCol10(txtName.Text.Trim(), hdnID.Value);
