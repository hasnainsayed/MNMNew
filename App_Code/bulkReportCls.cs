...
public class bulkReportCls
{
    ...
    public DataTable getRecord(string btnType, string frmDate, string toDate, string minval, string maxval, string commingfrom, string VendorID)
    {
        ...
        try
        {
            ...
            {
                command.CommandText =     "SELECT '0-30' as Age,  isnull(SUM(purchaseRate), 0) + isnull(SUM(travelCost), 0) + isnull(SUM(taxValue), 0) + ISNULL((select SUM(l.totalamount) FROM Lot l WHERE  l.IsActive = 3 AND(DATEDIFF(DAY, l.invoiceDate, GETDATE())) <= 30),0) AS 'Purchase Amount', ROUND((SELECT  isnull(SUM(purchaseRate), 0) + isnull(SUM(travelCost), 0) + isnull(SUM(taxValue), 0) + ISNULL((select SUM(l.totalamount) FROM Lot l WHERE  l.IsActive = 3 AND(DATEDIFF(DAY, l.invoiceDate, GETDATE())) <= 30), 0) from StockUpInward S WHERE(DATEDIFF(DAY, s.SystemDate, GETDATE())) <= 30) *100 / (Select isnull(SUM(purchaseRate), 0) + isnull(SUM(travelCost), 0) + isnull(SUM(taxValue), 0) + ISNULL((select SUM(l.totalamount) FROM Lot l WHERE l.IsActive = 3),0) FROM StockUpInward),2) AS Percentage from StockUpInward S WHERE(DATEDIFF(DAY, s.SystemDate, GETDATE())) <= 30  "+
                                          "UNION ALL SELECT '31-60' as Age,  isnull(SUM(purchaseRate), 0) + isnull(SUM(travelCost), 0) + isnull(SUM(taxValue), 0) + ISNULL((select SUM(l.totalamount) FROM Lot l WHERE  l.IsActive = 3 AND(DATEDIFF(DAY, l.invoiceDate, GETDATE())) > 30 AND(DATEDIFF(DAY, l.invoiceDate, GETDATE())) <= 60),0) AS 'Purchase Amount', ROUND((SELECT  isnull(SUM(purchaseRate), 0) + isnull(SUM(travelCost), 0) + isnull(SUM(taxValue), 0) + ISNULL((select SUM(l.totalamount) FROM Lot l WHERE  l.IsActive = 3 AND(DATEDIFF(DAY, l.invoiceDate, GETDATE())) > 30 AND(DATEDIFF(DAY, l.invoiceDate, GETDATE())) <= 60), 0) from StockUpInward S where (DATEDIFF(DAY, s.SystemDate, GETDATE())) > 30 AND(DATEDIFF(DAY, s.SystemDate, GETDATE())) <= 60) *100 / (Select isnull(SUM(purchaseRate), 0) + isnull(SUM(travelCost), 0) + isnull(SUM(taxValue), 0) + ISNULL((select SUM(l.totalamount) FROM Lot l WHERE l.IsActive = 3),0) FROM StockUpInward),2) AS Percentage from StockUpInward S where (DATEDIFF(DAY, s.SystemDate, GETDATE())) > 30 AND(DATEDIFF(DAY, s.SystemDate, GETDATE())) <= 60 " +
                                          "UNION ALL SELECT '61-90' as Age,  isnull(SUM(purchaseRate), 0) + isnull(SUM(travelCost), 0) + isnull(SUM(taxValue), 0) + ISNULL((select SUM(l.totalamount) FROM Lot l WHERE  l.IsActive = 3 and(DATEDIFF(DAY, l.invoiceDate, GETDATE())) > 60 AND(DATEDIFF(DAY, l.invoiceDate, GETDATE())) <= 90),0) AS 'Purchase Amount', ROUND((SELECT  isnull(SUM(purchaseRate), 0) + isnull(SUM(travelCost), 0) + isnull(SUM(taxValue), 0) + ISNULL((select SUM(l.totalamount) FROM Lot l WHERE  l.IsActive = 3 and(DATEDIFF(DAY, l.invoiceDate, GETDATE())) > 60 AND(DATEDIFF(DAY, l.invoiceDate, GETDATE())) <= 90), 0) from StockUpInward S where (DATEDIFF(DAY, s.SystemDate, GETDATE())) > 60 AND(DATEDIFF(DAY, s.SystemDate, GETDATE())) <= 90) *100 / (Select isnull(SUM(purchaseRate), 0) + isnull(SUM(travelCost), 0) + isnull(SUM(taxValue), 0) + ISNULL((select SUM(l.totalamount) FROM Lot l WHERE l.IsActive = 3),0) FROM StockUpInward),2) AS Percentage from StockUpInward S where (DATEDIFF(DAY, s.SystemDate, GETDATE())) > 60 AND(DATEDIFF(DAY, s.SystemDate, GETDATE())) <= 90 " +
                                          "UNION ALL SELECT '91-120' as Age,  isnull(SUM(purchaseRate), 0) + isnull(SUM(travelCost), 0) + isnull(SUM(taxValue), 0) + ISNULL((select SUM(l.totalamount) FROM Lot l WHERE  l.IsActive = 3 and(DATEDIFF(DAY, l.invoiceDate, GETDATE())) > 90 AND(DATEDIFF(DAY, l.invoiceDate, GETDATE())) <= 120),0) AS 'Purchase Amount', ROUND((SELECT isnull(SUM(purchaseRate), 0) + isnull(SUM(travelCost), 0) + isnull(SUM(taxValue), 0) + ISNULL((select SUM(l.totalamount) FROM Lot l WHERE  l.IsActive = 3 and(DATEDIFF(DAY, l.invoiceDate, GETDATE())) > 90 AND(DATEDIFF(DAY, l.invoiceDate, GETDATE())) <= 120), 0) from StockUpInward S where (DATEDIFF(DAY, s.SystemDate, GETDATE())) > 90 AND(DATEDIFF(DAY, s.SystemDate, GETDATE())) <= 120) *100 / (Select isnull(SUM(purchaseRate), 0) + isnull(SUM(travelCost), 0) + isnull(SUM(taxValue), 0) + ISNULL((select SUM(l.totalamount) FROM Lot l WHERE l.IsActive = 3),0) FROM StockUpInward),2) AS Percentage from StockUpInward S where (DATEDIFF(DAY, s.SystemDate, GETDATE())) > 90 AND(DATEDIFF(DAY, s.SystemDate, GETDATE())) <= 120 " +
                                          "UNION ALL SELECT '121-150' as Age,  isnull(SUM(purchaseRate), 0) + isnull(SUM(travelCost), 0) + isnull(SUM(taxValue), 0) + ISNULL((select SUM(l.totalamount) FROM Lot l WHERE  l.IsActive = 3 and(DATEDIFF(DAY, l.invoiceDate, GETDATE())) > 120 AND(DATEDIFF(DAY, l.invoiceDate, GETDATE())) <= 150),0) AS 'Purchase Amount', ROUND((SELECT  isnull(SUM(purchaseRate), 0) + isnull(SUM(travelCost), 0) + isnull(SUM(taxValue), 0) + ISNULL((select SUM(l.totalamount) FROM Lot l WHERE  l.IsActive = 3 and(DATEDIFF(DAY, l.invoiceDate, GETDATE())) > 120 AND(DATEDIFF(DAY, l.invoiceDate, GETDATE())) <= 150), 0) from StockUpInward S where (DATEDIFF(DAY, s.SystemDate, GETDATE())) > 120 AND(DATEDIFF(DAY, s.SystemDate, GETDATE())) <= 150) *100 / (Select isnull(SUM(purchaseRate), 0) + isnull(SUM(travelCost), 0) + isnull(SUM(taxValue), 0) + ISNULL((select SUM(l.totalamount) FROM Lot l WHERE l.IsActive = 3),0) FROM StockUpInward),2) AS Percentage from StockUpInward S where (DATEDIFF(DAY, s.SystemDate, GETDATE())) > 120 AND(DATEDIFF(DAY, s.SystemDate, GETDATE())) <= 150 " +
                                          "UNION ALL SELECT '151-180' as Age,  isnull(SUM(purchaseRate), 0) + isnull(SUM(travelCost), 0) + isnull(SUM(taxValue), 0) + ISNULL((select SUM(l.totalamount) FROM Lot l WHERE  l.IsActive = 3 and(DATEDIFF(DAY, l.invoiceDate, GETDATE())) > 150 AND(DATEDIFF(DAY, l.invoiceDate, GETDATE())) <= 180),0) AS 'Purchase Amount', ROUND((SELECT  isnull(SUM(purchaseRate), 0) + isnull(SUM(travelCost), 0) + isnull(SUM(taxValue), 0) + ISNULL((select SUM(l.totalamount) FROM Lot l WHERE  l.IsActive = 3 and(DATEDIFF(DAY, l.invoiceDate, GETDATE())) > 150 AND(DATEDIFF(DAY, l.invoiceDate, GETDATE())) <= 180), 0) from StockUpInward S where (DATEDIFF(DAY, s.SystemDate, GETDATE())) > 150 AND(DATEDIFF(DAY, s.SystemDate, GETDATE())) <= 180) *100 / (Select isnull(SUM(purchaseRate), 0) + isnull(SUM(travelCost), 0) + isnull(SUM(taxValue), 0) + ISNULL((select SUM(l.totalamount) FROM Lot l WHERE l.IsActive = 3),0) FROM StockUpInward),2) AS Percentage from StockUpInward S where (DATEDIFF(DAY, s.SystemDate, GETDATE())) > 150 AND(DATEDIFF(DAY, s.SystemDate, GETDATE())) <= 180 " +
                                          "UNION ALL SELECT '181-240' as Age,  isnull(SUM(purchaseRate), 0) + isnull(SUM(travelCost), 0) + isnull(SUM(taxValue), 0) + ISNULL((select SUM(l.totalamount) FROM Lot l WHERE  l.IsActive = 3 and(DATEDIFF(DAY, l.invoiceDate, GETDATE())) > 180 AND(DATEDIFF(DAY, l.invoiceDate, GETDATE())) <= 240),0) AS 'Purchase Amount', ROUND((SELECT  isnull(SUM(purchaseRate), 0) + isnull(SUM(travelCost), 0) + isnull(SUM(taxValue), 0) + ISNULL((select SUM(l.totalamount) FROM Lot l WHERE  l.IsActive = 3 and(DATEDIFF(DAY, l.invoiceDate, GETDATE())) > 180 AND(DATEDIFF(DAY, l.invoiceDate, GETDATE())) <= 240), 0) from StockUpInward S where (DATEDIFF(DAY, s.SystemDate, GETDATE())) > 180 AND(DATEDIFF(DAY, s.SystemDate, GETDATE())) <= 240) *100 / (Select isnull(SUM(purchaseRate), 0) + isnull(SUM(travelCost), 0) + isnull(SUM(taxValue), 0) + ISNULL((select SUM(l.totalamount) FROM Lot l WHERE l.IsActive = 3),0) FROM StockUpInward),2) AS Percentage from StockUpInward S where (DATEDIFF(DAY, s.SystemDate, GETDATE())) > 180 AND(DATEDIFF(DAY, s.SystemDate, GETDATE())) <= 240 " +
                                          "UNION ALL SELECT '241-300' as Age,  isnull(SUM(purchaseRate), 0) + isnull(SUM(travelCost), 0) + isnull(SUM(taxValue), 0) + ISNULL((select SUM(l.totalamount) FROM Lot l WHERE  l.IsActive = 3 and(DATEDIFF(DAY, l.invoiceDate, GETDATE())) > 240 AND(DATEDIFF(DAY, l.invoiceDate, GETDATE())) <= 300),0) AS 'Purchase Amount', ROUND((SELECT  isnull(SUM(purchaseRate), 0) + isnull(SUM(travelCost), 0) + isnull(SUM(taxValue), 0) + ISNULL((select SUM(l.totalamount) FROM Lot l WHERE  l.IsActive = 3 and(DATEDIFF(DAY, l.invoiceDate, GETDATE())) > 240 AND(DATEDIFF(DAY, l.invoiceDate, GETDATE())) <= 300), 0) from StockUpInward S where (DATEDIFF(DAY, s.SystemDate, GETDATE())) > 240 AND(DATEDIFF(DAY, s.SystemDate, GETDATE())) <= 300) *100 / (Select isnull(SUM(purchaseRate), 0) + isnull(SUM(travelCost), 0) + isnull(SUM(taxValue), 0) + ISNULL((select SUM(l.totalamount) FROM Lot l WHERE l.IsActive = 3),0) FROM StockUpInward),2) AS Percentage from StockUpInward S where (DATEDIFF(DAY, s.SystemDate, GETDATE())) > 240 AND(DATEDIFF(DAY, s.SystemDate, GETDATE())) <= 300 " +
                                          "UNION ALL SELECT '301-360' as Age,  isnull(SUM(purchaseRate), 0) + isnull(SUM(travelCost), 0) + isnull(SUM(taxValue), 0) + ISNULL((select SUM(l.totalamount) FROM Lot l WHERE  l.IsActive = 3 and(DATEDIFF(DAY, l.invoiceDate, GETDATE())) > 300 AND(DATEDIFF(DAY, l.invoiceDate, GETDATE())) <= 360),0) AS 'Purchase Amount', ROUND((SELECT  isnull(SUM(purchaseRate), 0) + isnull(SUM(travelCost), 0) + isnull(SUM(taxValue), 0) + ISNULL((select SUM(l.totalamount) FROM Lot l WHERE  l.IsActive = 3 and(DATEDIFF(DAY, l.invoiceDate, GETDATE())) > 300 AND(DATEDIFF(DAY, l.invoiceDate, GETDATE())) <= 360), 0) from StockUpInward S where (DATEDIFF(DAY, s.SystemDate, GETDATE())) > 300 AND(DATEDIFF(DAY, s.SystemDate, GETDATE())) <= 360) *100 / (Select isnull(SUM(purchaseRate), 0) + isnull(SUM(travelCost), 0) + isnull(SUM(taxValue), 0) + ISNULL((select SUM(l.totalamount) FROM Lot l WHERE l.IsActive = 3),0) FROM StockUpInward),2) AS Percentage from StockUpInward S where (DATEDIFF(DAY, s.SystemDate, GETDATE())) > 300 AND(DATEDIFF(DAY, s.SystemDate, GETDATE())) <= 360 " +
                                          "UNION ALL SELECT '360+' as Age,  isnull(SUM(purchaseRate), 0) + isnull(SUM(travelCost), 0) + isnull(SUM(taxValue), 0) + ISNULL((select SUM(l.totalamount) FROM Lot l WHERE  l.IsActive = 3 AND(l.invoiceDate is null OR(DATEDIFF(DAY, l.invoiceDate, GETDATE())) > 360)),0) AS 'Purchase Amount', ROUND((SELECT  isnull(SUM(purchaseRate), 0) + isnull(SUM(travelCost), 0) + isnull(SUM(taxValue), 0) + ISNULL((select SUM(l.totalamount) FROM Lot l WHERE  l.IsActive = 3 AND(l.invoiceDate is null OR(DATEDIFF(DAY, l.invoiceDate, GETDATE())) > 360)), 0) from StockUpInward S where (DATEDIFF(DAY, s.SystemDate, GETDATE())) > 360) *100 / (Select isnull(SUM(purchaseRate), 0) + isnull(SUM(travelCost), 0) + isnull(SUM(taxValue), 0) + ISNULL((select SUM(l.totalamount) FROM Lot l WHERE l.IsActive = 3),0) FROM StockUpInward),2) AS Percentage from StockUpInward S where (DATEDIFF(DAY, s.SystemDate, GETDATE())) > 360 " +
                                          "UNION ALL SELECT 'Grand Total' as Age,  isnull(SUM(purchaseRate), 0) + isnull(SUM(travelCost), 0) + isnull(SUM(taxValue), 0) + ISNULL((select SUM(l.totalamount) FROM Lot l WHERE l.IsActive = 3),0) AS 'Purchase Amount', ROUND((Select isnull(SUM(purchaseRate), 0) + isnull(SUM(travelCost), 0) + isnull(SUM(taxValue), 0) + ISNULL((select SUM(l.totalamount) FROM Lot l WHERE l.IsActive = 3), 0) FROM StockUpInward) *100 / (Select isnull(SUM(purchaseRate), 0) + isnull(SUM(travelCost), 0) + isnull(SUM(taxValue), 0) + ISNULL((select SUM(l.totalamount) FROM Lot l WHERE l.IsActive = 3),0) FROM StockUpInward),2) AS Percentage from StockUpInward";
            }
