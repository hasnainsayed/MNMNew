...
public class bulkReportCls
{
    ...
    public DataTable getRecord(string btnType, string frmDate, string toDate, string minval, string maxval, string commingfrom, string VendorID)
    {
        ...
        try
        {
            ...
            {
                command.CommandText = "SELECT VendorName,sum(a0to30) AS '0-30 Amount',  sum(p0to30) AS '0-30 Piece',SUM(a31to60) AS '31-60 Amount',SUM(p31to60) AS '31-60 Piece' " +
                                       ...
                                       "CASE When(DATEDIFF(DAY, l.entryDateTime, GETDATE())) <= 30 Then SUM(l.totalAmount) Else 0 END AS a0to30, " +
                                       "CASE When(DATEDIFF(DAY, l.entryDateTime, GETDATE())) <= 30 Then SUM(l.totalPiece) Else 0 END AS  p0to30, " +
                                       "CASE When(DATEDIFF(DAY, l.entryDateTime, GETDATE())) > 30 AND(DATEDIFF(DAY, l.entryDateTime, GETDATE())) <= 60 Then  SUM(l.totalAmount) Else 0 END AS a31to60, " +
                                       "CASE When(DATEDIFF(DAY, l.entryDateTime, GETDATE())) > 30 AND(DATEDIFF(DAY, l.entryDateTime, GETDATE())) <= 60 THEN  SUM(l.totalPiece) Else 0 END AS p31to60, " +
                                       "CASE When(DATEDIFF(DAY, l.entryDateTime, GETDATE())) > 60 AND(DATEDIFF(DAY, l.entryDateTime, GETDATE())) <= 90 Then  SUM(l.totalAmount) Else 0 END AS a61to90, " +
                                       "CASE When(DATEDIFF(DAY, l.entryDateTime, GETDATE())) > 60 AND(DATEDIFF(DAY, l.entryDateTime, GETDATE())) <= 90 THEN  SUM(l.totalPiece) Else 0 END AS p61to90, " +
                                       "CASE When(DATEDIFF(DAY, l.entryDateTime, GETDATE())) > 90 AND(DATEDIFF(DAY, l.entryDateTime, GETDATE())) <= 120 Then  SUM(l.totalAmount) Else 0 END AS a91to120, " +
                                       "CASE When(DATEDIFF(DAY, l.entryDateTime, GETDATE())) > 90 AND(DATEDIFF(DAY, l.entryDateTime, GETDATE())) <= 120 THEN  SUM(l.totalPiece) Else 0 END AS p91to120, " +
                                       "CASE When(DATEDIFF(DAY, l.entryDateTime, GETDATE())) > 120 AND(DATEDIFF(DAY, l.entryDateTime, GETDATE())) <= 150 Then  SUM(l.totalAmount) Else 0 END AS a121to150, " +
                                       "CASE When(DATEDIFF(DAY, l.entryDateTime, GETDATE())) > 120 AND(DATEDIFF(DAY, l.entryDateTime, GETDATE())) <= 150 THEN  SUM(l.totalPiece) Else 0 END AS p121to150, " +
                                       "CASE When(DATEDIFF(DAY, l.entryDateTime, GETDATE())) > 150 AND(DATEDIFF(DAY, l.entryDateTime, GETDATE())) <= 180 Then  SUM(l.totalAmount) Else 0 END AS a151to180, " +
                                       "CASE When(DATEDIFF(DAY, l.entryDateTime, GETDATE())) > 150 AND(DATEDIFF(DAY, l.entryDateTime, GETDATE())) <= 180 THEN  SUM(l.totalPiece) Else 0 END AS p151to180, " +
                                       "CASE When(DATEDIFF(DAY, l.entryDateTime, GETDATE())) > 180 AND(DATEDIFF(DAY, l.entryDateTime, GETDATE())) <= 240 Then  SUM(l.totalAmount) Else 0 END AS a181to240, " +
                                       "CASE When(DATEDIFF(DAY, l.entryDateTime, GETDATE())) > 180 AND(DATEDIFF(DAY, l.entryDateTime, GETDATE())) <= 240 THEN  SUM(l.totalPiece) Else 0 END AS p181to240, " +
                                       "CASE When(DATEDIFF(DAY, l.entryDateTime, GETDATE())) > 240 AND(DATEDIFF(DAY, l.entryDateTime, GETDATE())) <= 300 Then  SUM(l.totalAmount) Else 0 END AS a241to300, " +
                                       "CASE When(DATEDIFF(DAY, l.entryDateTime, GETDATE())) > 240 AND(DATEDIFF(DAY, l.entryDateTime, GETDATE())) <= 300 THEN  SUM(l.totalPiece) Else 0 END AS p241to300, " +
                                       "CASE When(DATEDIFF(DAY, l.entryDateTime, GETDATE())) > 300 AND(DATEDIFF(DAY, l.entryDateTime, GETDATE())) <= 360 Then  SUM(l.totalAmount) Else 0 END AS a301to360, " +
                                       "CASE When(DATEDIFF(DAY, l.entryDateTime, GETDATE())) > 300 AND(DATEDIFF(DAY, l.entryDateTime, GETDATE())) <= 360 Then  SUM(l.totalPiece) Else 0 END AS p301to360, " +
                                       "CASE WHEN((DATEDIFF(DAY, l.entryDateTime, GETDATE())) > 360) Then SUM(l.totalAmount) Else 0 END AS amore360, " +
                                       "CASE WHEN((DATEDIFF(DAY, l.entryDateTime, GETDATE())) > 360) Then SUM(l.totalPiece) Else 0 END AS pmore360, " +
