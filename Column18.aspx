<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Column18.aspx.cs" Inherits="Column18" %>
                         ...
                         <div class="row">
                             ...
                             <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="C18Name" runat="server" CssClass="form-control"></asp:TextBox>
                            ...
                            <tbody>
                                <asp:Repeater ID="GV" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            <td><%# Eval("Col18ID")%>
                                            <asp:Label ID="Col18ID" runat="server" Text='<%# Eval("Col18ID").ToString() %>' Visible="false"></asp:Label> 
