...
public partial class shopTransferReport2 : System.Web.UI.Page
{
    ...
    protected void btnexporttoexcel_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            bulkTransferReport2Cls obj = new bulkTransferReport2Cls();
            DataTable getDt = new bulkTransferReport2Cls().getRecords(frmDate.Text, toDate.Text);
            using (XLWorkbook wb = new XLWorkbook())
            {

                wb.Worksheets.Add(getDt, "Shop Transfer Report By Group");
                Response.Clear();
