...
public partial class Column7 : System.Web.UI.Page
{
    ...
    protected void rptr_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        if (e.CommandName.ToLower().Equals("edit"))
        {
            ...
            DataSet ds = objEdit.GetCol7ByID(ID);

            txtName.Text = ds.Tables[0].Rows[0]["C7Name"].ToString();
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        int ID = objAdd.AddCol7(txtName.Text.Trim());
        if (ID > 0)
        {
            BindColumn7();
            Clear();
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        int Success = objUpdate.UpdateCol7(txtName.Text.Trim(), hdnID.Value);
