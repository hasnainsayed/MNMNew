<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="accountingCentre.aspx.cs" Inherits="accountingCentre" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="content-wrapper">
        <section class="content-header">
            <h1>Accounting Centre
        <!--<small>it all starts here</small>-->
            </h1>
            <ol class="breadcrumb">
                <li><a href="Default.aspx"><i class="fa fa-dashboard"></i>Home</a></li>
                <li><a href="#">Masters</a></li>
                <li class="active">Accounting Centre</li>
            </ol>
        </section>
        <asp:UpdatePanel ID="UpdatePanel8" runat="server">
                ...
                <div class="box box-primary">
                 ...
                 <div class="col-md-6">
                                        ...
                                        <Label>AccCentreName</Label>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="centreName" ValidationGroup="save" runat="server" ErrorMessage=" is Mandatory" ForeColor="Red" /><br />

                                        <asp:TextBox ID="centreName" runat="server" CssClass="form-control"></asp:TextBox>

                                    </div>
                                     <div class="col-md-6">
                                 
                                        <Label>Currecncy</Label>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ControlToValidate="curency" ValidationGroup="save" runat="server" ErrorMessage="Selection  is Mandatory" ForeColor="Red" /><br />

                                       <asp:DropDownList ID="curency" runat="server" DataTextField="currencyName" DataValueField="currencyId" CssClass="form-control">
            ...
            <asp:Label ID="hdnID" runat="server" Text="" Visible="false"></asp:Label> 
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">
                            <asp:Button ID="btnadd" runat="server" Text="Add New Centre" class="btn btn-primary btn-sm" OnClick="btnadd_Click" /></h3>
                          </div>
                    <div class="box-body table-responsive">
                            ...
                            <tbody>
                                <asp:Repeater ID="GV" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            <td><%# Eval("centreId")%>
                                            <asp:Label ID="centreId" runat="server" Text='<%# Eval("centreId").ToString() %>' Visible="false"></asp:Label> 
