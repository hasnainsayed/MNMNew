<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Column20.aspx.cs" Inherits="Column20" %>
                         ...
                         <div class="row">
                             ...
                             <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="C20Name" runat="server" CssClass="form-control"></asp:TextBox>
                            ...
                            <tbody>
                                <asp:Repeater ID="GV" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            <td><%# Eval("Col20ID")%>
                                            <asp:Label ID="Col20ID" runat="server" Text='<%# Eval("Col20ID").ToString() %>' Visible="false"></asp:Label> 
