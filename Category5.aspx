<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Category5.aspx.cs" Inherits="ColumnTable4" %>
                    ...
                    <div class="box-body">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Select <asp:Label ID="lblCate4Name1" runat="server" Text=""></asp:Label></label></label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label><asp:Label ID="lblCatName" runat="server" Text=""></asp:Label></label></label>
                                    ...
                                    <table id="example111" class="table table-bordered table-striped dtSearch">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>ID</th>
                                                 <th><asp:Label ID="lblCat4Name" runat="server" Text=""></asp:Label></th>
                                                <th><asp:Label ID="lblCatName1" runat="server" Text=""></asp:Label></label></th>
                                                <th>Abbriviation</th>
                                                <th>Action</th>
                                            </tr>
                                        </thead>
                                                ...
                                                <ItemTemplate>
                                                    <tr>
                                                        <td><%# Eval("Cat5ID")%> </td>
                                                         <td><%# Eval("C4Name")%> </td>
                                                        <td><%# Eval("C5Name")%> </td>
                                                        <td><%# Eval("C5Abbriviation")%> </td>
                                                        <td>
                                                            <asp:ImageButton ID="ImageButton1" runat="server" CommandName="edit"
                                                                ImageUrl="images/edit.png" CommandArgument='<%# Eval("Cat5ID") %>' />
