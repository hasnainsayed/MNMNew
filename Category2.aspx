<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Category2.aspx.cs" Inherits="ColumnTable1" %>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <asp:Label ID="lblCat1" runat="server" Text=""></asp:Label></li>
            </ol>
        </section>
                ...
                <div class="box box-primary" id="ctfrmDet" runat="server" visible="false">
                    <div class="box-body">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>
                                    <asp:Label ID="lblCatName" runat="server" Text=""></asp:Label></label>
                                    ...
                                    <table id="example111" class="table table-bordered table-striped dtSearch">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Vertical</th>
                                                <th>
                                                    <asp:Label ID="lblCatName1" runat="server" Text=""></asp:Label></th>
                                                <th>Abbriviation</th>
                                                <th>Action</th>
                                            </tr>
                                        </thead>
                                            ...
                                            <asp:Repeater ID="GV" runat="server" OnItemCommand="rptr_ItemCommand">
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td><%# Eval("C2Name")%> </td>
                                                        <td><%# Eval("C2Abbriviation")%> </td>
                                                        <td>
                                                            <asp:ImageButton ID="ImageButton1" runat="server" CommandName="edit"
                                                                ImageUrl="images/edit.png" CommandArgument='<%# Eval("Cat2ID") %>' />
                                                        </td>
                                                    </tr>
                                                </ItemTemplate>
                                            </asp:Repeater>
