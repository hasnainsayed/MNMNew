<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AddItemStyle.aspx.cs" Inherits="AddItemStyle" %>
                        ...
                        <div class="col-xs-12">
                            <div class="box box-warning" style="margin-bottom: 0px !important">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Item Style</h3>
                                </div>
                                <div class="box-body">
                                    <div class="col-md-3">
                                    ...
                                    <div id="dvrbd1" visible="false" runat="server" class="col-md-3">
                                        <div class="form-group">
                                            <label>
