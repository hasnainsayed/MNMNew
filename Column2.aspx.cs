...
public partial class Column2 : System.Web.UI.Page
{
    ...
    protected void rptr_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        if (e.CommandName.ToLower().Equals("edit"))
        {
            ...
            DataSet ds = objEdit.GetCol2ByID(ID);
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        int ID = objAdd.AddCol2(txtName.Text.Trim());
        if (ID > 0)
        {
            BindColumn2();
            Clear();
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        int Success = objUpdate.UpdateCol2(txtName.Text.Trim(), hdnID.Value);
