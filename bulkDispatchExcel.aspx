<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="bulkDispatchExcel.aspx.cs" Inherits="bulkDispatchExcel" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        <div class="content-wrapper"> <section class="content-header">
        <h1>Bulk Dispatch - Excel
        <!--<small>it all starts here</small>-->
        </h1>
        <ol class="breadcrumb">
            <li><a href="Default.aspx"><i class="fa fa-dashboard"></i>Home</a></li>
            <li>Bulk Uploads</li><li>Bulk Dispatch</li>
            <li class="active">Bulk Dispatch - Excel</li>
        </ol>
    </section>
            ...
            <div class="box-body">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Bulk Dispatch - Excel</h3>
                    ...
                    <div class="box-body">
                         ...
                         <div class="row">
                           ...
                           <table class="table table-bordered">
                               <tr>
                                   <td>
                                       <asp:DropDownList ID="virtualLocation" Visible="false" AutoPostBack="true" runat="server" CssClass="form-control select2" DataTextField="Location" DataValueField="LocationID"></asp:DropDownList>
                                   </td>
                                   <td>
