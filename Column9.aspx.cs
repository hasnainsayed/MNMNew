...
public partial class Column9 : System.Web.UI.Page
{
    ...
    protected void rptr_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        if (e.CommandName.ToLower().Equals("edit"))
        {
            ...
            DataSet ds = objEdit.GetCol9ByID(ID);

            txtName.Text = ds.Tables[0].Rows[0]["C9Name"].ToString();
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        int ID = objAdd.AddCol9(txtName.Text.Trim());
        if (ID > 0)
        {
            BindColumn9();
            Clear();
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        int Success = objUpdate.UpdateCol9(txtName.Text.Trim(), hdnID.Value);
