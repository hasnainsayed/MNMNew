                    ...
                    <div class="box-body">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <asp:RequiredFieldValidator ControlToValidate="ddlVendor" ID="RequiredFieldValidator1"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <asp:RequiredFieldValidator runat="server" ForeColor="Red" ID="reqname" ErrorMessage="Please enter name" ControlToValidate="txtBags" Display="Dynamic" />
                                <asp:TextBox ID="txtBags" runat="server" CssClass="form-control"></asp:TextBox>
                            </div>
                        </div>

                          <div class="col-md-6">
                            <div class="form-group">
                                <label>Input Description For Bags</label>
                                <asp:RequiredFieldValidator runat="server" ForeColor="Red" ID="RequiredFieldValidator2" ErrorMessage="Please enter name" ControlToValidate="txtDescription" Display="Dynamic" />
                                                    ...
                                                    <tr>
                                                       ...
                                                       <%-- <td>
                                                            <asp:ImageButton ID="ImageButton1" runat="server" CommandName="edit"
                                                                ImageUrl="images/edit.png" CommandArgument='<%# Eval("LotID") %>' />
