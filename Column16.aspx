<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Column16.aspx.cs" Inherits="Column16" %>
                         ...
                         <div class="row">
                             ...
                             <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="C16Name" runat="server" CssClass="form-control"></asp:TextBox>
                            ...
                            <tbody>
                                <asp:Repeater ID="GV" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            <td><%# Eval("Col16ID")%>
                                            <asp:Label ID="Col16ID" runat="server" Text='<%# Eval("Col16ID").ToString() %>' Visible="false"></asp:Label> 
