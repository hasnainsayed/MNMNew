...
public partial class Location : System.Web.UI.Page
{
    ...
    {   
        ...
        DataSet ds = ObjBind.BindLocation();
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        int ID = objAdd.AddLocation(txtName.Text.Trim(), ddlLocationType.SelectedValue, ddlLocationType2.SelectedValue, txtContact.Text.Trim(), txtAddress.Text.Trim());
        if (ID > 0)
        {
            Clear();
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        int Success = objUpdate.UpdateLocation(txtName.Text.Trim(), ddlLocationType.SelectedValue, ddlLocationType2.SelectedValue, hdnID.Value, txtContact.Text.Trim(), txtAddress.Text.Trim());
