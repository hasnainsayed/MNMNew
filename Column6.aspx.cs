...
public partial class Column6 : System.Web.UI.Page
{
    ...
    protected void rptr_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        if (e.CommandName.ToLower().Equals("edit"))
        {
            ...
            DataSet ds = objEdit.GetCol6ByID(ID);

            txtName.Text = ds.Tables[0].Rows[0]["C6Name"].ToString();
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        int ID = objAdd.AddCol6(txtName.Text.Trim());
        if (ID > 0)
        {
            BindColumn6();
            Clear();
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        int Success = objUpdate.UpdateCol6(txtName.Text.Trim(), hdnID.Value);
