<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="latestProduct.aspx.cs" Inherits="latestProduct" %>
    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li>Website</li>
                <li class="active"><a  href="latestProduct.aspx">Latest Product</a></li>
...
<section class="content">
        ...
        ValidationGroup="addCode" runat="server" ErrorMessage="Style Code is required." forecolor="Red" /><br />
                        ...
                        <asp:Button ID="btnSave"  class="btn btn-success pull-right btn-round" runat="server" Text="Save Latest Product" OnClick="btnSave_Click" />
