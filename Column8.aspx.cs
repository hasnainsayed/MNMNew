...
public partial class Column8 : System.Web.UI.Page
{
    ...
    protected void rptr_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        if (e.CommandName.ToLower().Equals("edit"))
        {
            ...
            DataSet ds = objEdit.GetCol8ByID(ID);

            txtName.Text = ds.Tables[0].Rows[0]["C8Name"].ToString();
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        int ID = objAdd.AddCol8(txtName.Text.Trim());
        if (ID > 0)
        {
            BindColumn8();
            Clear();
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        int Success = objUpdate.UpdateCol8(txtName.Text.Trim(), hdnID.Value);
