<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Column11.aspx.cs" Inherits="Column11" %>
                         ...
                         <div class="row">
                             ...
                             <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="C11Name" runat="server" CssClass="form-control"></asp:TextBox>
                            ...
                            <tbody>
                                <asp:Repeater ID="GV" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            <td><%# Eval("Col11ID")%>
                                            <asp:Label ID="Col11ID" runat="server" Text='<%# Eval("Col11ID").ToString() %>' Visible="false"></asp:Label> 
