<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="customerCancelEmail.aspx.cs" Inherits="customerCancelEmail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="content-wrapper">
        <section class="content-header">
            <h1>Customer Cancellation Email
            </h1>
            <ol class="breadcrumb">
                <li><a href="Default.aspx"><i class="fa fa-dashboard"></i>Home</a></li>
                <li><a href="#">Communication Mgmt</a></li><li><a href="#">Emails</a></li>
                <li class="active"><a href="customerCancelEmail.aspx">Customer Cancellation Email</a></li>
            </ol>
        </section>
						...
						<div class="box-body">
							...
							<div class="box box-primary">
								<div class="box-header with-border">
									<h3 class="box-title">Update Customer Cancellation Email</h3>
                                </div>
								<!-- /.box-header -->
