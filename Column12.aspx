<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Column12.aspx.cs" Inherits="Column12" %>
                         ...
                         <div class="row">
                             ...
                             <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="C12Name" runat="server" CssClass="form-control"></asp:TextBox>
                            ...
                            <tbody>
                                <asp:Repeater ID="GV" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            <td><%# Eval("Col12ID")%>
                                            <asp:Label ID="Col12ID" runat="server" Text='<%# Eval("Col12ID").ToString() %>' Visible="false"></asp:Label> 
